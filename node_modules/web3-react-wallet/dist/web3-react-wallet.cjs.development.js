...
var setupNetwork = /*#__PURE__*/function () {
  var _ref = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(conf) {
    var provider, chains;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return provider.request({
              ...
              return provider.request({
                ...
                params: [{
                  chainId: "0x" + conf.chainId.toString(16)
                }]
              });
            });
          ...
          case 9:
            ...
            console.error("Failed to setup the network in Metamask:", _context.t0);
  ...
  return function setupNetwork(_x) {
...
var providers = function providers() {
  var chainId = react.useCallback(function (conf) {
    return conf && conf.chainId ? conf.chainId : 1;
  }, []);
  var injected = react.useCallback(function (conf) {
    return new injectedConnector.InjectedConnector({
      supportedChainIds: [conf && conf.chainId ? conf.chainId : 1]
    });
  }, []);
  var walletconnect = react.useCallback(function (conf) {
    return new walletconnectConnector.WalletConnectConnector({
      qrcode: true,
  ...
  var connectorsByName = react.useCallback(function (connectorID, conf) {
    var _connectors;

    var connectors = (_connectors = {}, _connectors[exports.ConnectorNames.Injected] = injected(conf), _connectors[exports.ConnectorNames.WalletConnect] = walletconnect(conf), _connectors);
    return connectors[connectorID];
  }, []);

  var getLibrary = function getLibrary(provider) {
    var library = new providers$1.Web3Provider(provider);
...
var useAuth = function useAuth() {
  ...
  var _providers = providers(),
      connectorsByName = _providers.connectorsByName;

  var login = react.useCallback(function (connectorID, config) {
    var connector = connectorsByName(connectorID, config);
              ...
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  if (error instanceof core.UnsupportedChainIdError) {
                    setupNetwork(config).then(function () {
                      return activate(connector);
                    });
                  } else {
                    localStorage.removeItem("connector");

                    if (error instanceof injectedConnector.NoEthereumProviderError) ; else if (error instanceof injectedConnector.UserRejectedRequestError || error instanceof walletconnectConnector.UserRejectedRequestError) {
  ...
  return {
    login: login,
    logout: logout,
    useWeb3React: core.useWeb3React,
    Web3ReactProvider: core.Web3ReactProvider
  };
};

exports.providers = providers;
exports.useAuth = useAuth;
//# sourceMappingURL=web3-react-wallet.cjs.development.js.map
