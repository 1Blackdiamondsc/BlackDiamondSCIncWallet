...
var providers = function providers() {
  var chainId = useCallback(function (conf) {
    return conf && conf.chainId ? conf.chainId : 1;
  }, []);
  var injected = useCallback(function (conf) {
    return new InjectedConnector({
      supportedChainIds: [conf && conf.chainId ? conf.chainId : 1]
    });
  }, []);
  var walletconnect = useCallback(function (conf) {
  ...
  var connectorsByName = useCallback(function (connectorID, conf) {
    var _connectors;

    var connectors = (_connectors = {}, _connectors[ConnectorNames.Injected] = injected(conf), _connectors[ConnectorNames.WalletConnect] = walletconnect(conf), _connectors);
...
var useAuth = function useAuth() {
  ...
  var login = useCallback(function (connectorID, config) {
              ...
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  if (error instanceof UnsupportedChainIdError) {
                    ...
                    if (error instanceof NoEthereumProviderError) ; else if (error instanceof UserRejectedRequestError || error instanceof UserRejectedRequestError$1) {
...
export { ConnectorNames, providers, useAuth };
//# sourceMappingURL=web3-react-wallet.esm.js.map
